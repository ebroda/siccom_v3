        ...
        if (yearly == 0) {
...

            {
                if (!(sim.schedule.getSteps() == 0) && bleacho == (sim.firstBleach * 12)) {
                    ...
                    while (tempDataYear == 1998)
                        tempDataYear = (int) (sim.random.nextDouble() * (maxYear - minYear + 1) + minYear);
